...
<head>
    ...
    $sql = 'SELECT * FROM niger WHERE days_in_db > (SELECT MAX(days_in_db) FROM niger) - 7 GROUP BY title ORDER BY score DESC';
    $result = $db->query($sql);
        ...
        <div class="row">
            ...
            <div class="col-md-5 col-8 art-style-back-red">
                <div class="row art-container-country">
                    ...
                    <div class="col-12">
                        <p class="art-style-text-white sec-font art-style-margins-country art-unselectable">Niger faces a myriad of challenges: food insecurity, malnutrition, epidemics, natural disasters, and extensive violence in – and a refugee crisis originating from – neighboring countries. Niger hosts numerous refugees from Mali and Nigeria, compounding, among other things, its growing nutritional crisis: the global acute malnutrition rate rose to 13.9% in 2017. Epidemics like Hepatis E and Meningitis, along with floods, which affected almost 200,000 people in 2017, also threaten Niger’s development. Niger is ranked 187th in the Human Development Index (2015).</p>
                    </div>
                </div>
            </div>
