...
<head>
    ...
    $sql = 'SELECT * FROM ethiopia WHERE days_in_db > (SELECT MAX(days_in_db) FROM ethiopia) - 7 GROUP BY title ORDER BY score DESC';
    $result = $db->query($sql);
        ...
        <div class="row">
            ...
            <div class="col-md-5 col-8 art-style-back-red">
                <div class="row art-container-country">
                    ...
                    <div class="col-12">
                        <p class="art-style-text-white sec-font art-style-margins-country art-unselectable">Disposed to unfavorable environmental conditions and unremitting disease outbreaks, Ethiopia has historically suffered from acute food insecurity crises. General conditions worsened in 2017. According to the OCHA, 8.5 million people needed relief food assistance by the end of 2017 (with up to 7 million suffering from acute food insecurity) – a spike from the figure of 5.6 million in January 2017. Ethiopia is ranked 174th in the Human Development Index (2015).</p>
                    </div>
                </div>
            </div>
