...
<head>
    ...
    $sql = 'SELECT * FROM burundi WHERE days_in_db > (SELECT MAX(days_in_db) FROM burundi) - 7 GROUP BY title ORDER BY score DESC';
    $result = $db->query($sql);
...
<body>
    ...
    <div class="container-fluid burundi-div-page">
        <div class="row art-style-10-height"></div>
        <div class="row">
            <div class="col-md-3 col-1"></div>
            <div class="col-md-6 col-10 art-style-back-red art-container-country">
                <p class="text-uppercase country-name-text art-unselectable">Burundi</p>
            </div>
            <div class="col-md-3 col-1"></div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-5 col-8 art-style-back-red">
                <div class="row art-container-country">
                    ...
                    <div class="col-12">
                        <p class="art-style-text-white sec-font art-style-margins-country art-unselectable">The humanitarian situation in Burundi has deteriorated since 2015. An increase in the price of commodities, the lack of social services, and budget restrictions have resulted in widespread public health problems and a lack of investment in education and water infrastructure. 65% of Burundi’s 11.7 million people live below the poverty line and, according to the latest Humanitarian Needs Overview, 3.6 million people require humanitarian assistance. Burundi ranks 184th in the Human Development Index (2015).</p>
                    </div>
                </div>
            </div>
