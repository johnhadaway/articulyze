...
<head>
    ...
    $sql = 'SELECT * FROM iraq WHERE days_in_db > (SELECT MAX(days_in_db) FROM iraq) - 7 GROUP BY title ORDER BY score DESC';
    $result = $db->query($sql);
        ...
        <div class="row">
            ...
            <div class="col-md-5 col-8 art-style-back-red">
                <div class="row art-container-country">
                    ...
                    <div class="col-12">
                        <p class="art-style-text-white sec-font art-style-margins-country art-unselectable">4 years of combat on Iraq’s civilian population has left its toll: ISIL displaced approximately 6 million people since the start of 2014. Major anti-ISIL operations have concluded, but 2.6 million people were still displaced at the end of 2017, and asymmetric attacks remain a concern. Iraq has entered a phase of reconstruction, and it is paramount that these reconstruction efforts – civilian protection, the reincorporation of displaced peoples, among others – are supported. Iraq is ranked 122nd in the Human Development Index (2015). </p>
                    </div>
                </div>
            </div>
