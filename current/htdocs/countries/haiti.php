...
<head>
    ...
    $sql = 'SELECT * FROM haiti WHERE days_in_db > (SELECT MAX(days_in_db) FROM haiti) - 7 GROUP BY title ORDER BY score DESC';
    $result = $db->query($sql);
        ...
        <div class="row">
            ...
            <div class="col-md-5 col-8 art-style-back-red">
                <div class="row art-container-country">
                    ...
                    <div class="col-12">
                        <p class="art-style-text-white sec-font art-style-margins-country art-unselectable">Hurricane Matthew had a lasting humanitarian impact on Haiti, affecting food security and the prevalence of disease, among other things. According to the revised Humanitarian Response Plan, roughly 1 million people in Haiti require emergency humanitarian assistance and approximately 2.8 million people remain in need. While the humanitarian situation improved in 2017 in many regards, it – quite clearly – remains unresolved. Haiti is ranked 163rd in the Human Development Index (2015).</p>
                    </div>
                </div>
            </div>
