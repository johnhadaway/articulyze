...
<head>
    ...
    $sql = 'SELECT * FROM palestine WHERE days_in_db > (SELECT MAX(days_in_db) FROM palestine) - 7 GROUP BY title ORDER BY score DESC';
    $result = $db->query($sql);
...
<body>
    ...
    <div class="container-fluid opt-div-page">
        <div class="row art-style-10-height"></div>
        <div class="row">
            <div class="col-md-3 col-1"></div>
            <div class="col-md-6 col-10 art-style-back-red art-container-country">
                <p class="country-name-text text-uppercase art-unselectable">occupied Palestinian territories (oPt)</p>
            </div>
            <div class="col-md-3 col-1"></div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-5 col-8 art-style-back-red">
                <div class="row art-container-country">
                    ...
                    <div class="col-12">
                        <p class="art-style-text-white sec-font art-style-margins-country art-unselectable">The occupied Palestinian territories (oPt) harbor a humanitarian crisis. It is among the world’s most longstanding crises, and it is largely owed to Israel’s ongoing occupation. Humanitarian conditions in the oPt worsened in 2017, partly due to growing internal Palestinian political divides. The OCHA estimates that approximately 2.5 million people in the region require humanitarian assistance. The oPt is ranked 114th in the Human Development Index (2015).</p>
                    </div>
                </div>
            </div>
