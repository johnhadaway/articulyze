...
<head>
    ...
    $sql = 'SELECT * FROM nigeria WHERE days_in_db > (SELECT MAX(days_in_db) FROM nigeria) - 7 GROUP BY title ORDER BY score DESC';
    $result = $db->query($sql);
...
<body>
    ...
    <div class="container-fluid nigeria-div-page">
        <div class="row art-style-10-height"></div>
        <div class="row">
            <div class="col-md-3 col-1"></div>
            <div class="col-md-6 col-10 art-style-back-red art-container-country">
                <p class="text-uppercase country-name-text art-unselectable">Nigeria</p>
            </div>
            <div class="col-md-3 col-1"></div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-5 col-8 art-style-back-red">
                <div class="row art-container-country">
                    ...
                    <div class="col-12">
                        <p class="art-style-text-white sec-font art-style-margins-country art-unselectable">Nigeria’s north-east region is home to a dire humanitarian crisis: violence in the region has led to mass displacement and violations of international humanitarian law. The conflict, now in its 9th year, has taken the lives of more than 20,000 people. 1.7 million people remain internally displaced, and approximately 200,000 were displaced externally in Cameroon, Chad and Niger. According to the OCHA, 7.7 million people in the region require humanitarian assistance. Nigeria is ranked 152nd in the Human Development Index (2015).</p>
                    </div>
                </div>
            </div>
