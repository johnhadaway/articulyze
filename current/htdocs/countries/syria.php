...
<head>
    ...
    $sql = 'SELECT * FROM syria WHERE days_in_db > (SELECT MAX(days_in_db) FROM syria) - 7 GROUP BY title ORDER BY score DESC';
    $result = $db->query($sql);
    ...
    <div class="container-fluid syria-div-page">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-10 art-style-back-red art-container-country">
                <p class="country-name-text text-uppercase art-unselectable">Syria</p>
            </div>
            <div class="col-md-3 col-1"></div>
        </div>
