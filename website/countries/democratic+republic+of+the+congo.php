...
<head>
    ...
    $sql = 'SELECT DISTINCT * FROM democratic+republic+of+the+congo WHERE days_in_db > (SELECT MAX(days_in_db) FROM democratic+republic+of+the+congo) - 7 ORDER BY score DESC';
    $result = $db->query($sql);
